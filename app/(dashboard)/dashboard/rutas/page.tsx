          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-black">Rutas totales</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-black">Completadas</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-black">Entregas totales</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div>
                <label className="text-xs text-black mb-1 block">Estado</label>
                <select
                  value={statusFilter}
              ...
              <div>
                <label className="text-xs text-black mb-1 block">Chofer</label>
                <select
                  value={driverFilter}
              ...
              <div>
                <label className="text-xs text-black mb-1 block">Desde</label>
                <input
                  type="date"
                  value={dateFrom}
              ...
              <div>
                <label className="text-xs text-black mb-1 block">Hasta</label>
                <input
                  type="date"
                  value={dateTo}
